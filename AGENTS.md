...
Bun demo app for Deepgram Live Transcription.
...
```
feat(bun-live-transcription): add diarization support
fix(bun-live-transcription): resolve WebSocket close handling
refactor(bun-live-transcription): simplify session endpoint
